...
function Navigation() {
    ...
    const [labeldata, setLabelData] = useState('Enable Cards')
    //for showing data in card
    ...
    const handleButton = () => {
        if (!toggleValue) {
            setToggleValue(true)
            setLabelData('Enable table')
        } else {
            setToggleValue(false)
            setLabelData('Enable Cards')
        }
    }
